...
GestionnaireBDD::GestionnaireBDD()
{
    ...
    if (bdd.open()) {
        ...
        if (query.exec("CREATE TABLE IF NOT EXISTS transac(id INT PRIMARY KEY, nomC VARCHAR(50), donneur VARCHAR(50), receveur VARCHAR(50), montant INT);")) {
            query.finish();
            query.exec("INSERT INTO transac VALUES ('1','Compte Henriette','claude@sfr.fr','henriette@orange.fr','10');");
            query.finish();
            query.exec("INSERT INTO transac VALUES ('2','Compte Claude','cunegonde@free.fr','claude@sfr.fr','50');");
            query.finish();
            query.exec("INSERT INTO transac VALUES ('3','Compte Cunégonde','patrocle@gmail.com','cunegonde@free.fr','160');");
            query.finish();
            query.exec("INSERT INTO transac VALUES ('18','Compte Cunégonde','patrocle@gmail.com','cunegonde@free.fr','-160');");
            query.finish();
            query.exec("INSERT INTO transac VALUES ('4','Compte Patrocle','octavie@orange.fr','patrocle@gmail.com','300');");
            query.finish();
            query.exec("INSERT INTO transac VALUES ('5','Compte Octavie','jeannic@sfr.fr','octavie@orange.fr','600');");
            query.finish();
            query.exec("INSERT INTO transac VALUES ('6','Compte JeanNic','henriette@orange.fr','jeannic@sfr.fr','1200');");
            query.finish();
        } else {
