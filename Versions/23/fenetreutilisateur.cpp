...
void FenetreUtilisateur::on_afficherinfo_clicked()
{
    ...
    case 1:
        DepensesPartagees* dp;
        dp = new DepensesPartagees(this, ui->comboBox->currentText().toStdString(), gestionnaire_dialogue);
        dp->setWindowTitle("Compte dépenses partagées"); // On nomme la fenêtre.
        dp->show(); // On affiche la fenêtre de dialogue, tant qu'elle n'est pas fermée, on attends.
        break;
    case 2:
        Cagnotte* c;
        c = new Cagnotte(this, ui->comboBox->currentText().toStdString(), gestionnaire_dialogue);
        c->setWindowTitle("Cagnotte"); // On nomme la fenêtre.
        c->show(); // On affiche la fenêtre de dialogue, tant qu'elle n'est pas fermée, on attends.
        break;
    case 3:
