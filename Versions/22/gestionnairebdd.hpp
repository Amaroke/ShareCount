...
public:
    ...
    /// @brief Fonction qui recherche le createur d'un compte dans la base de données à partir d'un nom de compte
    ///
    /// @param compte le nom à partir duquel la recherche s'effectue
    ///
    /// @return l'utilisateur trouvé ou un utilisateur avec des données vides si aucun utilisateur n'a été trouvé
    /// @version 22 @author L. Yvoz, univ. Lorraine
    Utilisateur recherche_createur(const QString& compte);
};
